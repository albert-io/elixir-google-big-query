...
defmodule GoogleApi.BigQuery.V2.Api.Datasets do
  ...
  def bigquery_datasets_delete(connection, project_id, dataset_id, optional_params \\ [], opts \\ []) do
  ...
  def bigquery_datasets_patch(connection, project_id, dataset_id, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
  ...
  def bigquery_datasets_update(connection, project_id, dataset_id, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
