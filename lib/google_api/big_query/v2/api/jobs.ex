...
defmodule GoogleApi.BigQuery.V2.Api.Jobs do
  ...
  def bigquery_jobs_get_query_results(connection, project_id, job_id, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
  ...
  def bigquery_jobs_insert_resumable(connection, project_id, upload_type, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
  ...
  def bigquery_jobs_insert_simple(connection, project_id, upload_type, metadata, data, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
