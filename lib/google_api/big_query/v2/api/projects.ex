...
defmodule GoogleApi.BigQuery.V2.Api.Projects do
  ...
  """
  @spec bigquery_projects_get_service_account(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.BigQuery.V2.Model.GetServiceAccountResponse.t} | {:error, Tesla.Env.t}
  def bigquery_projects_get_service_account(connection, project_id, optional_params \\ [], opts \\ []) do
