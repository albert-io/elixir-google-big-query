...
defmodule GoogleApi.BigQuery.V2.Model.JobStatistics2 do
  ...
  @type t :: %__MODULE__{
    ...
    :"reservationUsage" => list(GoogleApi.BigQuery.V2.Model.JobStatistics2ReservationUsage.t()),
  ...
  field(:"reservationUsage", as: GoogleApi.BigQuery.V2.Model.JobStatistics2ReservationUsage, type: :list)
