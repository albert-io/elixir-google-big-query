...
defmodule GoogleApi.BigQuery.V2.Model.TableDataInsertAllResponse do
  ...
  @type t :: %__MODULE__{
    :"insertErrors" => list(GoogleApi.BigQuery.V2.Model.TableDataInsertAllResponseInsertErrors.t()),
    :"kind" => any()
  }

  field(:"insertErrors", as: GoogleApi.BigQuery.V2.Model.TableDataInsertAllResponseInsertErrors, type: :list)
  field(:"kind")
end
